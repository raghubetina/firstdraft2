...
class Project::Table::Relationship::Indirect::HasMany < Project::Table::Relationship::Indirect
  belongs_to :table,
    foreign_key: :origin_id,
    counter_cache: :indirect_has_manies_count

  after_initialize { self.cardinality = :many }
end
